        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    {{-- Tombol Tambah Klub hanya akan muncul jika pengguna sudah login --}}
                    @auth
                    <div class="mb-4">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    {{-- Kolom Aksi hanya akan muncul jika pengguna sudah login --}}
                                    @auth
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($klubs as $klub)
                                    <tr>
                                        ...
                                        {{-- Tombol Edit & Hapus hanya akan muncul jika pengguna sudah login --}}
                                        @auth
                                ...
                                @empty
                                    <tr>
                                        {{-- Menyesuaikan colspan berdasarkan status login --}}
                                        <td colspan="{{ auth()->check() ? 5 : 4 }}" class="px-6 py-4 text-center text-sm text-gray-500">
                                            Belum ada data klub.
                                        </td>
                                    </tr>
                                @endforelse
