<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex text-green-900">
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                <x-nav-link :href="route('klub.index')" :active="request()->routeIs('klub.*')">
                    {{ __('Klub') }}
                </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('klub.index')" :active="request()->routeIs('klub.*')">
                {{ __('Klub') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('pemain.index')" :active="request()->routeIs('pemain.*')">
                {{ __('Pemain') }}
            </x-responsive-nav-link>
        </div>
